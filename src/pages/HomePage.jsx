...
import { Container, Row, Col, Card as BootstrapCard, Button as BootstrapButton, Form, InputGroup, Badge } from 'react-bootstrap'
...
const HomePage = () => {
  ...
  }, [])  // Mock data với nhiều khách sạn hơn
  const mockHotels = [
    {
      id: 1,
      ten_khach_san: "Grand Hotel Saigon",
      dia_chi: "Quận 1, TP.HCM",
      danh_gia: 4.8,
      so_luong_danh_gia: 245,
    ...
    {
      id: 2,
      ten_khach_san: "Sheraton Hanoi Hotel",
    ...
    {
      id: 3,
      ten_khach_san: "InterContinental Da Nang",
      dia_chi: "Ngũ Hành Sơn, Đà Nẵng",
      danh_gia: 4.9,
      so_luong_danh_gia: 321,
    ...
    {
      id: 4,
      ten_khach_san: "Vinpearl Resort Phú Quốc",
    ...
    {
      id: 5,
      ten_khach_san: "Muong Thanh Luxury Nha Trang",
      dia_chi: "Nha Trang, Khánh Hòa",
      danh_gia: 4.5,
      so_luong_danh_gia: 278,
    ...
    {
      id: 6,
      ten_khach_san: "JW Marriott Hotel Hanoi",
      dia_chi: "Ba Đình, Hà Nội",
      danh_gia: 4.9,
      so_luong_danh_gia: 412,
    ...
    {
      id: 7,
      ten_khach_san: "Rex Hotel Saigon",
      dia_chi: "Quận 1, TP.HCM",
      danh_gia: 4.4,
      so_luong_danh_gia: 198,
    ...
    {
      id: 8,
      ten_khach_san: "FLC Luxury Hotel Sầm Sơn",
      dia_chi: "Sầm Sơn, Thanh Hóa",
      danh_gia: 4.3,
      so_luong_danh_gia: 134,
    ...
    {
      id: 9,
      ten_khach_san: "The Reverie Saigon",
      dia_chi: "Quận 1, TP.HCM",
      danh_gia: 4.9,
      so_luong_danh_gia: 287,
  ...
  const mockDestinations = [
    { id: 1, ten_tinh: "TP. Hồ Chí Minh", hinh_anh: "https://images.unsplash.com/photo-1583417319070-4a69db38a482?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: 2, ten_tinh: "Hà Nội", hinh_anh: "https://images.unsplash.com/photo-1509145842959-2bea64309564?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: 3, ten_tinh: "Đà Nẵng", hinh_anh: "https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: 4, ten_tinh: "Phú Quốc", hinh_anh: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: 5, ten_tinh: "Nha Trang", hinh_anh: "https://images.unsplash.com/photo-1515859005217-8a1f08870f59?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" },
    { id: 6, ten_tinh: "Hạ Long", hinh_anh: "https://images.unsplash.com/photo-1528127269322-539801943592?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" }
  ]
                ...
                <Col lg={4} md={6} key={destination.id} className="mb-4">
                  ...
                  >
                    <BootstrapCard
                      ...
                      onClick={() => navigate(`/search?destination=${destination.ten_tinh}`)}
                    >
                      <div className="position-relative overflow-hidden" style={{ height: '200px' }}>
                        <ImageWithFallback 
                          src={destination.hinh_anh} 
                          alt={destination.ten_tinh}
                        ...
                        >
                          <h5 className="text-white fw-bold text-center">{destination.ten_tinh}</h5>
                        </div>
                      </div>
                    </BootstrapCard>
                  </motion.div>
                      ...
                      <BootstrapCard.Body className="p-3">
                        ...
                        <div className="d-flex align-items-center mb-2">
                          <div className="d-flex align-items-center me-3">
                            <div className="me-1">
                              {renderStars(hotel.danh_gia)}
                            </div>
                            <strong className="me-1 small">{hotel.danh_gia}</strong>
                            <small className="text-muted">({hotel.so_luong_danh_gia})</small>
                          </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="text-start">
                            <small className="text-muted text-decoration-line-through">
                              {formatPrice(hotel.gia_thap_nhat * 1.15)}
                            </small>
                      ...
                      <BootstrapCard.Body className="p-4">
                        <div className="d-flex align-items-center justify-content-between mb-3">
                          <div className="d-flex align-items-center">
                            ...
                            <strong className="me-2">{hotel.danh_gia}</strong>
                            <small className="text-muted">({hotel.so_luong_danh_gia} đánh giá)</small>
                          </div>
                        </div>
