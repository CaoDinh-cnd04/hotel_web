...
const AdminProfilePage = () => {
  ...
  // Fetch admin profile - using mock data from auth store
    ...
    <div className="p-8">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-slate-900">Hồ sơ Admin</h1>
        </div>
        <p className="text-slate-600">Quản lý thông tin cá nhân và cài đặt tài khoản quản trị</p>
      </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div style={{ position: 'relative', marginTop: '4px' }}>
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none disabled:bg-slate-50"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      disabled={!isEditing}
                      className="w-full h-10 px-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent disabled:bg-slate-50"
                    >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-sky-600">Admin</span>
                </div>
                <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                disabled={changePasswordMutation.isLoading}
                className="flex-1 px-4 py-2 text-sm font-medium text-white bg-sky-600 rounded-lg hover:bg-sky-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
