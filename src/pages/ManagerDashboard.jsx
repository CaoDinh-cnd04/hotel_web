...
import { LogOut, Building2, DoorOpen, Calendar, BarChart3, Star, Settings, LayoutDashboard, Bell } from 'lucide-react'
import { useAuthStore } from '../stores/authStore'
import NotificationBell from '../components/notifications/NotificationBell'

// Import manager pages
import Overview from './manager-hotel/Overview'
import Rooms from './manager-hotel/Rooms'
import Bookings from './manager-hotel/Bookings'
import Reviews from './manager-hotel/Reviews'
import Services from './manager-hotel/Services'
import Statistics from './manager-hotel/Statistics'
// import HotelSettings from './manager-hotel/HotelSettings'
...
const sections = [
  ...
  { id: 'services', label: 'Dịch vụ khách sạn', icon: Settings },
  { id: 'statistics', label: 'Thống kê', icon: BarChart3 },
  { id: 'reviews', label: 'Đánh giá', icon: Star },
  { id: 'settings', label: 'Cài đặt khách sạn', icon: Building2 }
]
      ...
      case 'settings':
        return (
          <div className="p-12 text-center">
            <h2 className="text-2xl font-bold text-slate-700 mb-4">Cài đặt khách sạn</h2>
            <p className="text-slate-500">Trang cài đặt sẽ được cập nhật sau</p>
          </div>
        )
      case 'profile':
