...
import { discountService, mockDiscountService } from '../services/discountService'
  ...
  const handleValidateDiscount = async () => {
    ...
    try {
      ...
      if (token && user) {
        ...
        result = await discountService.validateDiscountCode(discountCode, orderAmount, token)
      } else {
        // Use mock service for demo
        result = await mockDiscountService.validateDiscountCode(discountCode, orderAmount)
      }
